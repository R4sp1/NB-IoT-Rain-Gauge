...
\title[Návrh přesného srážkoměru s možností real-time odečtu]{Návrh přesného srážkoměru s možností real-time odečtu}

%%% Označení oboru studia
%  Parametr ve složených závorkách {} je název oboru v originálním jazyce,
%  parametr v hranatých závorkách [] je překlad
\specialization[Telecommunication and information systems]{Telekomunikační a informační systémy}
